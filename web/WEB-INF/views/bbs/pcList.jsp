...
<div class="container-fluid">
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-2 col-md-3 col-sm-4 col-xs-12 panel-group" id="accordion" role="tablist">
									...
									<div>
										<div>
											<div>
												...
												<img src="<c:url value="/resources/${pc.getPcListImgVO().getMainImg()}" />" width="240" height="180">
												</a>
											</div>
											<div>
												<div>
